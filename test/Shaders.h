...
private:
	...
	ID3D11PixelShader* PixelPosTexFirstpassSHader = nullptr;
...
public:
	...
	void deferedrenderingtexvsgsps(ID3D11DeviceContext * &gDeviceContext, ID3D11ShaderResourceView *& gTextureView);
